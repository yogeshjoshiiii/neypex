  ...
  if (useDrive) {
    return (
      ...
      >
        ...
        {/* Mask Drive's share / popout / kebab buttons (top-right and bottom-right) */}
        <div className="absolute top-0 right-0 h-16 w-56 sm:w-64 bg-black z-10" />
        <div className="absolute bottom-0 right-0 h-14 w-28 sm:w-32 bg-black z-10" />
        {/* Block right-click and long-press anywhere on the player */}
        <div
